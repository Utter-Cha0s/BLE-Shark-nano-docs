...
Welcome to your BLEShark Nano! This guide will walk you through the setup process.  
Before starting, ensure your device is fully charged. **Keep the switch ON while charging!**

**Follow these steps to set up your BLEShark Nano:**
...
<Tabs>
  ...
  If nothing shows up, open a browser and go to [neverssl.com](http://neverssl.com) to force the login page.  
